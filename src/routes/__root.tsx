...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Brian Ngatia builds scalable AI-powered applications across full-stack, data engineering, and machine learning." },
      { name: "author", content: "Brian Ngatia" },
      { property: "og:title", content: "Brian Ngatia — Full-Stack, Data & AI Engineer" },
      { property: "og:description", content: "Portfolio of Brian Ngatia — full-stack systems, data pipelines, and applied AI." },
